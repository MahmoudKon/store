...
<div class="footer-top">
  <div class="container-fluid">
    ...
    <div class="col-xs-4 w3l-rightmk">
      <img src="{{asset('ui/images/tab3.jpg')}}" alt=" ">
    </div>
  ...
  <div class="container">
    ...
    <div class="footer-info w3-agileits-info">
      ...
      <div class="col-sm-2 footer-grids  w3l-socialmk">
        ...
        <div class="agileits_app-devices">
          ...
          <a href="#">
            <img src="{{asset('ui/images/1.png')}}" alt="">
          </a>
          <a href="#">
            <img src="{{asset('ui/images/2.png')}}" alt="">
          </a>
          <div class="clearfix"> </div>
        </div>
      </div>
    ...
    <div class="agile-sometext">
      ...
      <div class="sub-some child-momu">
        ...
        <ul>
          <li>
            <img src="{{asset('ui/images/pay2.png')}}" alt="">
          </li>
          <li>
            <img src="{{asset('ui/images/pay5.png')}}" alt="">
          </li>
          <li>
            <img src="{{asset('ui/images/pay1.png')}}" alt="">
          </li>
          <li>
            <img src="{{asset('ui/images/pay4.png')}}" alt="">
          </li>
          <li>
            <img src="{{asset('ui/images/pay6.png')}}" alt="">
          </li>
          <li>
            <img src="{{asset('ui/images/pay3.png')}}" alt="">
          </li>
          <li>
            <img src="{{asset('ui/images/pay7.png')}}" alt="">
          </li>
          <li>
            <img src="{{asset('ui/images/pay8.png')}}" alt="">
          </li>
          <li>
            <img src="{{asset('ui/images/pay9.png')}}" alt="">
          </li>
        </ul>
      </div>
      <!-- //payment -->
