        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('site.categories') : {{ $categories->total() }}</h3>
                    ...
                    <form action="{{ route('dashboard.categories.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <?php $count = App\category::onlyTrashed()->count(); ?>
                                <?php $countTrashed = $count > 99 ? '+99' : $count; ?>
                                <?php $endedClass = $countTrashed > 0 ? 'trashed' : '' ?>
                                <a href="{{ route('dashboard.categories.deleted') }}" class="btn btn-danger {{ $endedClass }}"><i class="fa fa-trash"></i> @lang('site.deleted')</a>
                                @endif
                            </div>
