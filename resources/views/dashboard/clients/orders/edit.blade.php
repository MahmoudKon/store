                                                ...
                                                @if ($category->products->count() > 0)
                                                    ...
                                                    <table class="table table-hover">
                                                        ...
                                                        @foreach ($category->products as $product)
                                                            <tr>
                                                                <td>{{ $product->name }}</td>
                                                                <td class="change-stock">@if($product->stock < 1) Ended
                                                                ...
                                                                <td>
                                                                    @if($product->stock < 1)
                                                                    <button class="btn btn-default disabled btn-sm"><i class="fa fa-plus"></i></button>
                                                                    @else
                                                                    <a href=""
                                    ...
                                    @foreach ($order->productsWithTrashed as $product)
                                        <tr>
                                            ...
                                            <td><input type="number"
                                                    ...
                                                    min="1"
                                                    max="{{ $product->stock > $product->pivot->quantity ? $product->stock : $product->pivot->quantity }}"
                                                    value="{{ $product->pivot->quantity }}">
                                            </td>
                                            <td class="product-price">
                                                {{ number_format($product->all_price * $product->pivot->quantity, 2) }}
                                            </td>
                                            <td>
