        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <form action="{{ route('dashboard.products.EndProducts') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <?php $allClass = $countAll > 0 ? 'available' : '' ?>
                                <a href="{{ route('dashboard.products.index') }}" class="btn btn-info {{ $allClass }}"> <i class="fa fa-list"></i> @lang('site.available_stock') </a>

                                <?php $trashed = App\Product::onlyTrashed()->count(); ?>
                                <?php $countTrashed = $trashed > 99 ? '+99' : $trashed; ?>
                                <?php $altrashedClass = $countTrashed > 0 ? 'trashed' : '' ?>
                                <a href="{{ route('dashboard.products.deleted') }}" class="btn btn-danger {{ $altrashedClass }}"> <i class="fa fa-trash"></i> @lang('site.deleted') </a>
                            </div>
