    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('dashboard.products.index') }}"> @lang('site.profile')</a></li>
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.profile.update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password" class="form-control" placeholder="change password if you want" value="{{ old('password') }}">
                        </div>
